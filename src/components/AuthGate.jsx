        ...
        <div className="w-full max-w-sm">
          <div className="auth-card flex flex-col items-center text-center">
            ...
            <button
              ...
              className="auth-google-btn mt-10 w-full h-11 rounded-full border border-border bg-card hover:bg-accent text-sm flex items-center justify-center gap-3 transition-colors cursor-pointer"
            >
