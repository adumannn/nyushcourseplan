...
BEGIN
  IF to_regclass('public.reviews') IS NOT NULL THEN
    EXECUTE 'DROP POLICY IF EXISTS "Users manage own reviews" ON public.reviews';
    EXECUTE 'DROP POLICY IF EXISTS "Reviews are readable by all authenticated users" ON public.reviews';
