...
- Incomplete requirement rows are shortcuts into a requirement-filtered course picker; when opened from the requirements panel, the student chooses the destination semester before adding a course.
